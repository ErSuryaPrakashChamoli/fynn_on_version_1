        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start">
            ...
            <div class="min-w-0 lg:w-1/3">
                <div class="rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="max-h-[44rem] space-y-5 overflow-y-auto p-4">
                        @if ($selectedDate)
                            <div>
                                <h4 class="mb-2 flex items-center justify-between text-xs font-bold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                                    <span>Lead Follow-ups</span>
                                    <span class="rounded-full bg-primary-50 px-2 py-0.5 text-primary-700 dark:bg-primary-500/10 dark:text-primary-400">
                                        {{ $leadFollowUps->count() }}
                                    </span>
                                </h4>
                            ...
                            <div>
                                <h4 class="mb-2 flex items-center justify-between text-xs font-bold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                                    ...
                                    <span class="rounded-full bg-teal-50 px-2 py-0.5 text-teal-700 dark:bg-teal-500/10 dark:text-teal-400">
                                        {{ $customerFollowUps->count() }}
                                    </span>
                                </h4>
