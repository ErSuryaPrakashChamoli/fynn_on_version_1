                ...
                <div class="lead-followup-calendar-card rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
                    <div class="lead-followup-calendar-card__header flex flex-wrap items-center justify-between gap-2 border-b border-gray-200 px-4 py-3 dark:border-gray-700">
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-sm font-semibold text-gray-950 dark:text-white">My Customer Follow-up Calendar</h3>
                        </div>
                ...
                <div class="rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="border-b border-gray-200 px-4 py-3 dark:border-gray-700">
                        <h3 class="text-sm font-semibold text-gray-950 dark:text-white">
                            @if ($selectedDate)
                                Customer Follow-ups on {{ \Carbon\Carbon::parse($selectedDate)->format('d M Y') }}
                            @else
                                Customer Follow-ups
                            @endif
                        </h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            Click any date on the calendar to see that day's customer follow-ups here.
                        </p>
                    </div>
