...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:512000'],        // 500MB — matches OcrDocumentForm's FileUpload::maxSize(512000).
        ...
        'max_upload_time' => 60, // Minutes — raised from the 5-minute default so a 500MB file has time to finish on a slow connection.
